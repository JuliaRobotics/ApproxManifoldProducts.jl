...
plot(
    layer(; x = xx, y = y1, Geom.line),
    layer(; x = xx, y = y2, Geom.line, Theme(; default_color = colorant"deepskyblue")),
    layer(; x = xx, y = yy, Geom.line, Theme(; default_color = colorant"magenta")),
)
